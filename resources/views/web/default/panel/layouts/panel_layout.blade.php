...
<head>
    ...
    <!-- General CSS File -->
    <link href="/assets/default/css/font.css?v={{ config('app.asset_ver') }}" rel="stylesheet">

    <link rel="stylesheet" href="/assets/default/vendors/sweetalert2/dist/sweetalert2.min.css?v={{ config('app.asset_ver') }}">
    ...
    <link rel="stylesheet" href="/assets/default/css/panel.css?v={{ config('app.asset_ver') }}">
