        ...
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            ...
            <form action="" method="get">
                <div class="d-flex align-items-center flex-row-reverse flex-md-row justify-content-start justify-content-md-center mt-20 mt-md-0">
                    <label class="cursor-pointer mb-0 ml-10 font-weight-500 font-14 text-gray" for="conductedSwitch">{{ trans('panel.only_not_conducted_webinars') }}</label>
            ...
            <a href="/panel/webinars/new" class="d-none d-lg-flex btn btn-sm btn-primary rounded-pill" style="margin-left: 20px"> اضافة فصل </a>
        </div>
                                    ...
                                    @if($webinar->isOwner($authUser->id) or $webinar->isPartnerTeacher($authUser->id))
                                        <div class="btn-group dropdown table-actions">
                                            ...
                                            <div class="dropdown-menu ">
                                                ...
                                                <a href="/panel/webinars/{{ $webinar->id }}/ShowStudents" class="webinar-actions d-block mt-10">عرض المتدربين</a>
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                    ...
                                    @if($webinar->isProgressing() and !empty($nextSession))
                                        <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                            ...
                                            <span class="stat-value">{{ convertMinutesToHourAndMinute($nextSession->duration) }} ساعة</span>
                                        </div>
                                    ...
                                    @else
                                        <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                            ...
                                            <span class="stat-value">{{ convertMinutesToHourAndMinute($webinar->duration) }} ساعة</span>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                        <span class="stat-title">المتدربين:</span>
