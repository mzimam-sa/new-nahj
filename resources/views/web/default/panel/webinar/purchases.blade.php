...
<h2 class="section-title">الدورات والدبلومات</h2>
{{-- 
    ...
    <div class="row">
        <div class="col-4 d-flex align-items-center justify-content-center">
            <div class="d-flex flex-column align-items-center text-center">
                ...
                <span class="font-16 text-gray font-weight-500">إجمالي التسجيلات</span>
            </div>
        </div>
        ...
        <div class="col-4 d-flex align-items-center justify-content-center">
            <div class="d-flex flex-column align-items-center text-center">
                ...
                <span class="font-16 text-gray font-weight-500">ساعة تعليمية</span>
            </div>
        </div>
        ...
        <div class="col-4 d-flex align-items-center justify-content-center">
            <div class="d-flex flex-column align-items-center text-center">
                ...
                <span class="font-16 text-gray font-weight-500">محتوى تعليمي لم يبدأ بعد</span>
            </div>
        </div>
                                ...
                                @endif --}}
                                        ...
                                        <div class="btn-group dropdown table-actions">
                                            ...
                                            <div class="dropdown-menu">
                                                @if (!empty($sale->gift_id) and $sale->buyer_id == $authUser->id and $sale->online_payment_method != 'تحويل مباشر')
                                                ...
                                                @else
                                                    ...
                                                    @elseif(!empty($sale->webinar))
                                                        ...
                                                        @if ($item->price > 0  and $sale->online_payment_method != 'تحويل مباشر')
                                                            <a href="/panel/webinars/{{ $item->id }}/sale/{{ $sale->id }}/invoice"
                                                                target="_blank"
                                                                class="webinar-actions d-block mt-10">{{ trans('public.invoice') }}</a>
                                                        @endif
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                        ...
                                        @elseif(!empty($sale->bundle))
                                            <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                <span class="stat-title">{{ trans('update.diplomaduration') }}:</span>
                                                <span class="stat-value">{{ $item->diploma_hours }}</span>
                                            </div>
                                        @endif --}}
