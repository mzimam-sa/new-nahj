                ...
                <div class="course-content-body user-select-none">
                    <div class="course-body-on-cover text-white">
                        ...
                        {{-- <span class="d-block font-16 mt-80">{{ trans('update.inDiploma') }} <a
                                ...
                                <span class="d-block font-16 mt-80">{{ $bundle->category->title }}</span>
                    ...
                    <div class="px-20 pb-30">
                        <form action="/cart/store" method="post">
                            ...
                            <div class="mt-20 d-flex flex-column">
                                @if ($hasBought or !empty($bundle->getInstallmentOrder()))
                                    <button type="button" class="btn btn-primary"
                                        disabled>{{ trans('panel.bundle_purchased') }}</button>
                            ...
                            <div>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone ml-10"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                    ...
                    <div class="mt-30">
                        <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="ml-5 font-14 font-weight-500">{{ trans('update.diplomaduration') }}:</span>
                            </div>
                            <span class="font-14">{{ $bundle->diploma_hours }}</span>
                        </div>
                        ...
                        <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="ml-5 font-14 font-weight-500">{{ trans('update.bundle_content') }}:</span>
                            </div>
                            <span class="font-14">{{ $bundle->bundleWebinars->count() }}</span>
                        </div>

                        {{-- تعطيل جزء تاريخ الانشاء  --}}
                        {{--
                            <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                                <div class="d-flex align-items-center">
                                    <img src="/assets/default/img/icons/sessions.svg" width="20" alt="">
