...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \App\User::updateOrCreate(['id' => 7], ['full_name' => 'supervisor', 'mobile' => '09379332009','role_name' => 'اشراف{الكلاس- متابعة المتدربين}', 'email' => 'manar95sahow@gmail.com', 'role_id' => 12, 'password' => password_hash('123456', PASSWORD_BCRYPT),'status' => 'active','created_at' => '1597826952','updated_at' => '1597826952']);
