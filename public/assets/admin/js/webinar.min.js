...
(function ($) {
  ...
  * */
  ...
  $('body').on('click', '#AddStudySchedule', function (e) {
    e.preventDefault();
    var add_studyschedule_modal = '<div id="StudyScheduleModal">';
    add_studyschedule_modal += $('#StudyScheduleModal').html(); // تبديل الفورم الخاصة بتخزين البيانات
    add_studyschedule_modal += '</div>';
    Swal.fire({
      html: add_studyschedule_modal,
      showCancelButton: false,
      showConfirmButton: false,
      customClass: {
        content: 'p-0 text-left'
