...
class Sale extends Model
{
    ...
    public static function createSales($orderItem, $payment_method, $online_payment_method = null, $online_payment_method_id = null)
    {
        ...
        $sale = Sale::create([
            ...
            'online_payment_method_id' => $online_payment_method_id,
